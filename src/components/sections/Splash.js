...
<div className="row vh-100">
    ...
    <div className="col-lg-7 col-md-7 col-sm-11 d-flex justify-content-center align-items-center">
        <div className="heading-home align-self-center">
            ...
            <h1 className="heading-home--sub  u-margin-bottom-medium">Web Developer</h1>
            ...
            <button className="btn btn--circle btn-icon">
                    <a href="#section-contact"><i className="far fa-envelope btn__icon"></i></a>
                </button>

            <button className="btn btn--circle btn-icon">
                    <a href="https://github.com/xemotionalx" target="_blank" rel="noopener noreferrer"><i className="fab fa-github-alt btn__icon"></i></a>
                </button>

            <button className="btn btn--circle btn-icon">
                    <a href="https://www.linkedin.com/in/maiadac/" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin-in btn__icon"></i></a>
                </button>
        </div>
    ...
    <div className="col-lg-4 col-md-4 col-sm-11  d-flex justify-content-center align-items-center">
        <div className="home-box align-self-center">
            <a href="#section-about">
                <img src="assets/images/about-me/selfportrait.png" alt="self portrait" className="home-img img-fluid" />
            </a>
        </div>
    </div>
